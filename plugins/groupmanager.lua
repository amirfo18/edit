...
if not lang then
text = [[
*Star King Bot Commands:افزودن ادمین گروه(در صورت اینکه ربات سازنده گروه باشد)_*
